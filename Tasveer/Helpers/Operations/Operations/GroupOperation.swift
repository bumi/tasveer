...
class GroupOperation: Operation {
    ...
    init(operations: [Foundation.Operation], maxConcurrentOperationCount: Int = Foundation.OperationQueue.defaultMaxConcurrentOperationCount) {
        super.init()
        
        internalQueue.maxConcurrentOperationCount = maxConcurrentOperationCount
